...
llm_output = {
    ...
    "plan_level_results": [
        ...
        {
            "category": "Financial Review",
            "sub_category": "Wealth Plan current scenario",
            "summaries": [
                {
                    "scenario": "advisor or client led plan",
...
#     "agent": "example_agent",
#     "plan_level_results": [{"sub_category": "Wealth Plan current scenario", "Insights": [], "summaries": []}],
#     "goal_level_results": [{"sub_category": "Net Worth", "Insights": [], "summaries": []}],
# }
