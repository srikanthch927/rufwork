    ...
    "goal_level_results": [
        {
           "category": "Financial Review",
            ...
            "Insights": [
               { "scenario": "advisor or client led plan",
                    "Insight": "in goal level insights",
        }]
        }
    ]
}
...
def construct_component_fixed_unique(llm_output):
...
component_fixed_unique = construct_component_fixed_unique(llm_output)
print(json.dumps(component_fixed_unique, indent=4))
